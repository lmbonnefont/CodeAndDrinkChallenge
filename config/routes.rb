Rails.application.routes.draw do
  ...
  get '/users/:user_id/games/:game_id/uploadphotowinner', to: 'games#uploadphotowinner', as: :user_game_uploadphotowinner #un peu dégueu mais fonctionne ... A voir s'il n'y a pas mieux
  ...
  post '/users/:user_id/games/:game_id/fame', to: 'games#fame', as: :user_game_fame #un peu dégueu mais fonctionne ... A voir s'il n'y a pas mieux
